...
from image_utils import delete_profile_image,process_profile_img,upload_profile_image
...
async def upload_profile_picture(
    ...
    try:
        processed_bytes, new_filename = await run_in_threadpool(process_profile_img,content)
